...
<body>
    ...
    <div class="container">
        ...
        if($action=='cantdelete'){
            echo "<div class='alert alert-danger'>Unable to delete due to existing order</div>";
        }


        // select all data
        $query = "SELECT id, first_name, last_name, email, status, image FROM customer ORDER BY id DESC";
